...
class StoreLandingPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // The linked entity is required only for the type that consumes it.
            'clinic_id'   => ['nullable', 'required_if:type,clinic', 'exists:clinics,id'],
            'offer_id'    => ['nullable', 'required_if:type,offer', 'exists:offers,id'],
            'city_id'     => ['nullable', 'required_if:type,city', 'exists:cities,id'],
            'category_id' => ['nullable', 'required_if:type,category', 'exists:categories,id'],

            'comparison_clinic_ids'   => ['nullable', 'required_if:type,comparison', 'array', 'min:2'],
