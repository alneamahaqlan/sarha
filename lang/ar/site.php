...
return [
    ...
    'account_my_rewards' => 'مكافآتي',
    'account_no_rewards' => 'ليس لديك مكافآت بعد — احضر مواعيدك لتجمع مكافآت من المجمّعات.',
    'reward_intro' => 'مكافآتك من المجمّعات الطبية. كل مكافأة تخصّ مجمعها، تُستخدم مرة واحدة، ويمكنك تحويلها لمن تشاء.',
    'reward_active_section' => 'مكافآت متاحة',
    'reward_history_section' => 'السجل',
    'reward_from_clinic' => 'من :clinic',
    'reward_desc_free_service' => 'خدمة مجانية: :service',
    'reward_desc_offer_percent' => 'خصم :value% على عرض «:offer»',
    'reward_desc_offer_amount' => 'خصم :value ريال على عرض «:offer»',
    'reward_expires' => 'تنتهي في :date',
    'reward_no_expiry' => 'بلا تاريخ انتهاء',
    'reward_transfer_cta' => 'تحويل لشخص آخر',
    'reward_transfer_phone_label' => 'جوال المستلم',
    'reward_transfer_submit' => 'تحويل',
    'reward_transfer_hint' => 'تبقى المكافأة مخصّصة لنفس المجمع وبنفس تاريخ الانتهاء. إن لم يكن للمستلم حساب، نرسل له رسالة بالهدية.',
    'reward_transferred_ok' => 'تم تحويل المكافأة بنجاح.',
    // Booking-form voucher picker + apply feedback
    'reward_picker_title' => 'مكافأة الكاش باك',
    'reward_picker_none' => 'بدون مكافأة',
    'reward_picker_hint' => 'ستُطبَّق على هذا الحجز، ويؤكّدها المجمع عند زيارتك.',
    'reward_picker_none_available' => 'لا توجد لديك مكافآت مطابقة لهذه الخدمة.',
    'reward_picker_guest_hint' => 'إن وصلك كود مكافأة (هدية) عبر رسالة، أدخله هنا.',
    'reward_apply_ok' => 'تم تطبيق مكافأتك: :desc — يؤكّدها المجمع عند الزيارة.',

    // Verified reviews (account + submission)
    'account_my_reviews' => 'تقييماتي',
    'review_account_intro' => 'قيّم زياراتك المؤكَّدة. تقييمك موثّق لأننا نعرف أنك حضرت فعلًا.',
    'review_pending_section' => 'بانتظار تقييمك',
    'review_pending_hint' => 'زيارة مؤكَّدة — شاركنا رأيك فيها.',
    'review_rate_now' => 'قيّم الآن',
    'review_no_pending' => 'لا توجد زيارات بانتظار التقييم.',
    'review_published_section' => 'تقييماتك المنشورة',
    'review_clinic_reply_by' => 'رد :name',
    'review_form_title' => 'قيّم زيارتك في :clinic',
    'review_form_subtitle' => 'رأيك الصادق يساعد غيرك — إيجابيًا كان أو سلبيًا.',
    'review_clinic_rating' => 'تقييم تجربة المجمع',
    'review_scale_hint' => '1 = سيئة · 5 = ممتازة',
    'review_doctor' => 'الطبيب (اختياري)',
    'review_doctor_none' => 'لم أُحدّد طبيبًا',
    'review_doctor_rating' => 'تقييم الطبيب',
    'review_comment' => 'تعليقك (اختياري)',
    'review_comment_placeholder' => 'صف تجربتك في الزيارة…',
    'review_public_notice' => 'سيُنشر تقييمك علنًا على صفحة المجمع، ويمكن للمجمع الرد عليه.',
    'review_submit' => 'إرسال التقييم',
    'review_thanks' => 'شكرًا لتقييمك! تم نشره.',
    'review_already_submitted' => 'لقد قيّمت هذه الزيارة مسبقًا. شكرًا لك!',
    'review_back_to_clinic' => 'العودة لصفحة المجمع',
    'review_already_submitted_err' => 'تم تقديم هذا التقييم مسبقًا.',
    'review_not_attended_err' => 'لا يمكن التقييم — الزيارة غير مؤكَّدة الحضور.',
    'review_invite_sms' => 'كيف كانت زيارتك للمجمع :clinic؟ قيّم تجربتك عبر صرحة: :link',
    'review_anon' => 'مريض',
    ...
    'reward_gift_sms' => 'وصلتك مكافأة هدية من :clinic عبر منصة صرحة. سجّل بنفس رقم جوالك لاستلامها.',
    'reward_available_sms' => 'تذكير: لديك مكافأة متاحة من :clinic عبر صرحة. استخدمها في زيارتك القادمة.',
    'reward_status' => [
        'active'  => 'متاحة',
        'used'    => 'مستخدمة',
        'expired' => 'منتهية',
    ...
    'ai_new_chat_confirm' => 'هل تريد بدء محادثة جديدة؟ سيتم مسح المحادثة الحالية.',
...
لا تشارك هذا الرمز مع أي شخص. صالح لمدة 5 دقائق.',
    ...
    'otp_invalid_attempts' => 'رمز التحقق غير صحيح. لديك :count محاولة متبقية.',
    'otp_too_many_attempts' => 'لقد تجاوزت عدد المحاولات المسموح بها. يرجى طلب رمز تحقق جديد.',
    'otp_expired_request_new' => 'انتهت صلاحية رمز التحقق أو لم يُرسَل بعد. يرجى طلب رمز جديد.',
    'otp_network_error' => 'تعذّر الاتصال بالخادم. يرجى المحاولة مرة أخرى.',
    'otp_resend' => 'إعادة إرسال الرمز',
    'otp_resend_in' => 'إعادة الإرسال بعد :seconds ثانية',
