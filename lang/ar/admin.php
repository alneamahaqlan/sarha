...
return [
    ...
    'catchall_service_locked' => 'خدمة «خدمات أخرى» تُدار تلقائيًا ولا يمكن تعديلها أو حذفها.',
    ...
    'team' => [
        'forbidden_role'        => 'صلاحياتك لا تسمح بالوصول إلى هذه الصفحة.',
        'phone_taken'           => 'هذا الرقم مُستخدَم في فريقك مسبقاً.',
        'phone_in_use_by_owner' => 'هذا الرقم يَخص حساب مدير مجمع آخر.',
        'role_invalid'          => 'الدور غير صالح. اختر منسّق أو استقبال.',
        'removed_ok'            => 'تم إزالة العضو. تاريخ نشاطه السابق محفوظ.',
        'no_package'            => 'بلا باقة',
    ],
];
