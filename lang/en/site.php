...
return [
    ...
    // Cashback rewards (account side)
    'account_my_rewards' => 'My rewards',
    'account_no_rewards' => 'No rewards yet — attend your appointments to earn rewards from clinics.',
    'reward_intro' => 'Your rewards from medical complexes. Each is locked to its clinic, single-use, and transferable to anyone you choose.',
    'reward_active_section' => 'Available rewards',
    'reward_history_section' => 'History',
    'reward_from_clinic' => 'from :clinic',
    'reward_desc_free_service' => 'Free service: :service',
    'reward_desc_offer_percent' => ':value% off the offer “:offer”',
    'reward_desc_offer_amount' => ':value SAR off the offer “:offer”',
    'reward_expires' => 'Expires :date',
    'reward_no_expiry' => 'No expiry',
    'reward_transfer_cta' => 'Transfer to someone',
    'reward_transfer_phone_label' => 'Recipient mobile',
    'reward_transfer_submit' => 'Transfer',
    'reward_transfer_hint' => 'The reward stays locked to the same clinic with the same expiry. If the recipient has no account, we text them about the gift.',
    'reward_transferred_ok' => 'Reward transferred successfully.',
    // Booking-form voucher picker + apply feedback
    'reward_picker_title' => 'Cashback reward',
    'reward_picker_none' => 'No reward',
    'reward_picker_hint' => 'It will be applied to this booking and confirmed by the clinic at your visit.',
    'reward_picker_none_available' => 'You have no rewards matching this service.',
    'reward_picker_guest_hint' => 'If you received a reward (gift) code by message, enter it here.',
    'reward_apply_ok' => 'Your reward was applied: :desc — confirmed by the clinic at your visit.',

    // Verified reviews (account + submission)
    'account_my_reviews' => 'My reviews',
    'review_account_intro' => 'Rate your confirmed visits. Your review is verified because we know you actually attended.',
    'review_pending_section' => 'Awaiting your review',
    'review_pending_hint' => 'A confirmed visit — share your experience.',
    'review_rate_now' => 'Rate now',
    'review_no_pending' => 'No visits awaiting a review.',
    'review_published_section' => 'Your published reviews',
    'review_clinic_reply_by' => ':name replied',
    'review_form_title' => 'Rate your visit to :clinic',
    'review_form_subtitle' => 'Your honest feedback helps others — positive or negative.',
    'review_clinic_rating' => 'Clinic experience rating',
    'review_scale_hint' => '1 = poor · 5 = excellent',
    'review_doctor' => 'Doctor (optional)',
    'review_doctor_none' => 'I didn’t specify a doctor',
    'review_doctor_rating' => 'Doctor rating',
    'review_comment' => 'Your comment (optional)',
    'review_comment_placeholder' => 'Describe your visit experience…',
    'review_public_notice' => 'Your review will be published publicly on the clinic page, and the clinic may reply to it.',
    'review_submit' => 'Submit review',
    'review_thanks' => 'Thanks for your review! It has been published.',
    'review_already_submitted' => 'You have already reviewed this visit. Thank you!',
    'review_back_to_clinic' => 'Back to the clinic page',
    'review_already_submitted_err' => 'This review was already submitted.',
    'review_not_attended_err' => 'Can’t review — the visit attendance isn’t confirmed.',
    'review_invite_sms' => 'How was your visit to :clinic? Rate your experience on Sarha: :link',
    'review_anon' => 'Patient',
    ...
    'reward_gift_sms' => 'You received a gift reward from :clinic via Sarha. Sign up with this mobile number to claim it.',
    'reward_available_sms' => 'Reminder: you have an available reward from :clinic via Sarha. Use it on your next visit.',
    'reward_status' => [
        'active'  => 'Available',
        'used'    => 'Used',
        'expired' => 'Expired',
