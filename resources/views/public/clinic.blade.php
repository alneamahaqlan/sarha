...
@endpush
{{-- Specialty filter store + story viewer (shared with the landing-page hero). --}}
...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    {{-- Hero Card (protected — always renders). Extracted to a partial so the
         landing-page "clinic header section" mode can reuse it verbatim. --}}
