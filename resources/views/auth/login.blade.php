    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-sm p-8">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-purple-600 mb-1">@lang('site.brand')</h1>
                ...
                <form method="POST" action="{{ route('login.otp') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="tel" name="phone" value="{{ old('phone') }}" required
                               ...
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 text-center tracking-wider"
                               dir="ltr">
                    </div>
            ...
            @else
                ...
                <form method="POST" action="{{ route('login.verify') }}" class="space-y-4">
                    ...
                    <div class="text-center text-sm text-gray-600 mb-2">
                        ...
                        @if(session('dev_code'))
                            <br><span class="text-purple-600 font-bold">{{ __('site.dev_code', ['code' => session('dev_code')]) }}</span>
                        @endif
                    </div>
                    <div>
                        ...
                        <input type="text" name="code" maxlength="6" required
                               placeholder="XXXXXX"
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-400 text-center tracking-[0.5em] text-xl"
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('login') }}" class="text-sm text-gray-500 hover:text-purple-600">@lang('site.change_phone')</a>
                </div>
            @endif
        </div>
    </div>
